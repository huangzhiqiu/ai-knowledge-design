...
description: >-
  ...
  "PRD", "product requirements", or mentions task-driven development.
allowed-tools:
  - Read
  - Write
  - Edit
...
```
Returns array of USER-TEST task definitions.
...
If generating:
1. Load template from `~/.claude/skills/prd-taskmaster/templates/CLAUDE.md.template`
...
**If Autonomous**: Display same summary plus execution mode, then begin execution.
...
---
*Source: https://github.com/Synafast/prd-taskmaster*
*Note: This skill requires script.py and templates/ directory. TaskMaster (MCP or CLI) is a hard dependency.*
