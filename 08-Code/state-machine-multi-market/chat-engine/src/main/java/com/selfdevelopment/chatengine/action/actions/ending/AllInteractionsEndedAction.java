...
/**
 * Action executed when all interactions have ended (ENDING 鈫?ENDING internal, or ENDING 鈫?CLOSED if endingActionsDone).
 * <p>
...
public class AllInteractionsEndedAction implements ConditionalAction<ConversationState, ConversationFact, CbolStateContext> {
