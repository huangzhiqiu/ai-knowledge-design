...
/**
 * Action executed when target interaction is initiated (TRANSFERRED 鈫?TRANSFERRED, internal).
 * <p>
...
public class TargetInteractionInitiatedAction implements ConditionalAction<ConversationState, ConversationFact, CbolStateContext> {
