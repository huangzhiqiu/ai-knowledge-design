...
import com.selfdevelopment.statemachine.timeout.impl.InMemoryTimeoutScheduler;

import com.selfdevelopment.statemachine.timeout.impl.TimeoutAwareStateMachine;
...
class TimeoutTest {
    ...
    void shouldAutoFireTimeoutEvent() throws InterruptedException {
        ...
        machine.addListener(new com.selfdevelopment.statemachine.api.StateMachineListener<>() {
            @Override
