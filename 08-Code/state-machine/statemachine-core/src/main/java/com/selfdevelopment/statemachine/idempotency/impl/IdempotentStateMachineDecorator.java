package com.selfdevelopment.statemachine.idempotency.impl;

import com.selfdevelopment.statemachine.idempotency.ProcessedEventStore;
...
public class IdempotentStateMachineDecorator<S, E, C> implements StateMachine<S, E, C> {
    ...
    @Override
    public StateContext<S, E, C> fireEvent(S sourceState, E event, C context,
                                             com.selfdevelopment.statemachine.core.ExtendedState extendedState) {
