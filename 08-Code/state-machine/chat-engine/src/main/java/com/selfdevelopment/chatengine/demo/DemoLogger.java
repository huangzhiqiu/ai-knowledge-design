...
public class DemoLogger {
    ...
    /**
     * Prints the initial state of a conversation/interaction.
     *
     * @param state    the initial state
     * @param entityId the entity ID (conversationId or interactionId)
     * @param market   the market
     */
    public static void printInitialState(String state, String entityId, String market) {
        System.out.println();
        System.out.println(color("  📍 Initial State", BOLD + YELLOW));
        System.out.printf("     %s Entity: %s%n", timestamp(), entityId);
     ...
     */
    public static void printFinalState(String finalState, String entityId) {
        System.out.println();
