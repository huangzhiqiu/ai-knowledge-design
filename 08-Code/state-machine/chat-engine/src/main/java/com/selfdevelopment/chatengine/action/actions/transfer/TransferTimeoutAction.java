...
/**
 * Action executed when transfer times out (TRANSFERRED 鈫?INITIATED).
 * <p>
...
@Slf4j
@Component
@HandlesFact(ConversationFact.TRANSFER_TIMEOUT)
public class TransferTimeoutAction implements ConditionalAction<ConversationState, ConversationFact, CbolStateContext> {
