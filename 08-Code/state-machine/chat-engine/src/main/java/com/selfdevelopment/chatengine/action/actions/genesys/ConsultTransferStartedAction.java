...
/**
 * Action executed when Genesys consult transfer starts (ACTIVE/IN_PROGRESS 鈫?ACTIVE/IN_PROGRESS internal).
 * <p>
...
public class ConsultTransferStartedAction implements ConditionalAction<ConversationState, ConversationFact, CbolStateContext> {
