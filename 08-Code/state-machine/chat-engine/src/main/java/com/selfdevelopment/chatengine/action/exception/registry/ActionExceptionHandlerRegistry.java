package com.selfdevelopment.chatengine.action.exception.registry;

import com.selfdevelopment.chatengine.action.exception.handler.ActionExceptionHandler;
import com.selfdevelopment.chatengine.action.exception.handler.FallbackActionExceptionHandler;
 ...
 * @see com.selfdevelopment.chatengine.action.exception.wrapper.ExceptionHandlingAction
 */
@Slf4j
@Component
