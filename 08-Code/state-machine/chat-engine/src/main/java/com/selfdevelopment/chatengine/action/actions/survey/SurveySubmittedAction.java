...
/**
 * Action executed when survey is submitted (ENDING 鈫?ENDING internal transition).
 * <p>
...
public class SurveySubmittedAction implements ConditionalAction<ConversationState, ConversationFact, CbolStateContext> {
