...
/**
 * Action executed when ending times out (ENDING → CLOSED).
 * <p>
...
@Slf4j
@Component
public class EndingTimeoutAction implements Action<ConversationState, ConversationFact, CbolStateContext> {
