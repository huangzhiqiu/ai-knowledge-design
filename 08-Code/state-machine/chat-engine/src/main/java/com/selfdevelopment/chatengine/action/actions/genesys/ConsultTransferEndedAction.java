...
/**
 * Action executed when Genesys consult transfer ends (ACTIVE/IN_PROGRESS 鈫?ACTIVE/IN_PROGRESS internal).
 * <p>
...
@Slf4j
@Component
@HandlesFact(ConversationFact.GENESYS_CONSULT_TRANSFER_ENDED)
public class ConsultTransferEndedAction implements ConditionalAction<ConversationState, ConversationFact, CbolStateContext> {
